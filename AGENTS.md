...
- **Agent context**: Review relevant definitions under `.codex/agents/*` before specialized tasks, and use the appropriate agent when it materially helps the requested work.
